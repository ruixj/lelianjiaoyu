...
function weixin_js() {
    ...
    $wxsripts =  '<script> wx.config({
					...
					jsApiList: [
					  ...
					  "onMenuShareTimeline","onMenuShareAppMessage","previewImage"
					]
				  });
				  </script>';
    echo $wxsripts;				  
		...
		if (( bp_loggedin_user_id() && !bp_displayed_user_id())  || bp_is_my_profile())
		{
			...
			)
			{
				$classroomclass = "selected";
			          ...
			          (bp_is_activity_component() && bp_is_current_action('following'))
...
?>	
			...
			<li>
				<a id='myfriends' href="<?php echo $friendslst_link ; ?>" class="<?php echo $myFriendclass;?>">好朋友</a>
			</li>
			<li>
				<a id='newfriends' href="<?php echo $newFriendlst_link ; ?>" class="<?php echo $newFriendclass;?>">待审核</a>
			</li>
			<li>
				<a id='findfriends' href="<?php echo $find_link ; ?>" class="<?php echo $findclass;?>">+加好友</a>
			</li>			
<?php						
		}	
	}
